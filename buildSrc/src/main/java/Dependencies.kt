object Versions {
    ...
    const val liveDataKtx = "2.4.0-beta01"
    const val lifecycleRuntimeKtx = "2.4.0-beta01"
    const val viewModelCompose = "2.4.0-beta01"
    ...
    const val kspApi = "1.5.30-1.0.0-beta09"
