    ...
    class EventViewHolder(
        ...
        fun bind(data: Event, position: Int) {
            ...
            fun setPrimaryTextSpan(text: String) {
                ...
                actionBuilder.setSpan(ForegroundColorSpan(ResourcesCompat.getColor(itemView.resources, R.color.colorTextPrimary, null)), actionBuilder.length - text.length + 1, actionBuilder.length - 1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
            }
