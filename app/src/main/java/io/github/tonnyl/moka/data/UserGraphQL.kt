...
data class UserGraphQL(
    ...
    companion object {
        ...
        fun createFromFollowerRaw(data: FollowersQuery.Node?): UserGraphQL? = if (data == null) {
            null
        } else {
            UserGraphQL(
                data.avatarUrl(),
        ...
        fun createFromFollowingRaw(data: FollowingQuery.Node?): UserGraphQL? = if (data == null) {
            null
        } else {
            UserGraphQL(
                data.avatarUrl(),
        ...
        fun createFromRaw(data: UserQuery.User?): UserGraphQL? = if (data == null) {
            null
        } else {
            UserGraphQL(
                data.avatarUrl(),
