...
fun AppCompatTextView.notificationContent(
    ...
    val notificationReasonContent = context.getString(notificationTypeResId)
    val notificationReasonPlusHyphen = context.getString(R.string.notification_caption_notification_type, notificationReasonContent)
