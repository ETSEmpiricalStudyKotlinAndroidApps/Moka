...
open class FollowingLiveData(
        private val login: String
) : LiveData<Response<FollowingQuery.Data>>() {

    private val TAG = FollowingLiveData::class.java.simpleName

    private val call = NetworkClient.apolloClient
            .query(FollowingQuery.builder().login(login).build())
